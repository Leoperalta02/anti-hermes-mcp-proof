          ...
          <div id="crm-tab-compose" class="crm-tab-content">
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; margin-top:0.75rem; flex-wrap:wrap; gap:0.5rem;">
              <div style="font-size:0.75rem; color:var(--text-secondary);">
                🛡️ <em>Human-in-the-Loop: Logged to client CRM timeline and prepared for dispatch.</em>
              </div>
              <div style="display:flex; gap:0.5rem;">
                <button class="btn-sm" onclick="openMailtoClient()">External Mail Client ↗</button>
                <button class="btn-approve" style="padding:0.55rem 1.25rem;" onclick="sendCrmReply()">✓ Log & Dispatch Message</button>
              </div>
            </div>
            <div id="crm-reply-feedback" style="display:none; color:var(--success); font-size:0.82rem; margin-top:0.75rem; font-weight:600;">
              ✓ Message logged to client conversation ledger and Copilot updated.
            </div>
          </div>
