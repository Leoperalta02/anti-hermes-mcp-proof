        ...
        <div class="card intake-form-card">
          ...
          <form id="listing-intake-form" onsubmit="submitListingIntake(event)">
            ...
            <div class="crm-field">
              ...
              <textarea class="crm-textarea" name="photos" id="intake-photos" rows="3" required placeholder="https://..."></textarea>
            </div>
            <div class="crm-field">
              <label class="crm-label">Video URL (optional)</label>
              <input class="crm-input" name="video_url" id="intake-video" placeholder="https://...">
            </div>
  ...
  <script>
    ...
    async function runListingAutoFetch() {{
      ...
      try {{
        ...
        if (fPhotos && data.photos) fPhotos.value = data.photos.join('\\n');
