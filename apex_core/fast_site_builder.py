        ...
        <section>
          ...
          <div class="contact-row">
            ...
            <div class="contact-info">
              <div class="contact-name">Maria Rodriguez <span class="heat-badge heat-hot">HOT</span></div>
              <div class="contact-meta">Buyer — Pre-approved $680K • Last contact: 3 days ago • Showing: Bella Terra</div>
            </div>
            <div class="contact-actions">
              <button class="btn-action primary" onclick="logAction(this,'Called Maria')">📞 Call</button>
          ...
          <div class="contact-row">
            ...
            <div class="contact-info">
              <div class="contact-name">David & Karen Walsh <span class="heat-badge heat-hot">HOT</span></div>
              <div class="contact-meta">Seller — 22001 West Bay Blvd • CMA delivered yesterday, no response</div>
            </div>
            <div class="contact-actions">
              <button class="btn-action primary" onclick="logAction(this,'Called Walsh')">📞 Call</button>
          ...
          <div class="contact-row">
            ...
            <div class="contact-info">
              <div class="contact-name">Jennifer Liu <span class="heat-badge heat-warm">WARM</span></div>
              <div class="contact-meta">Referral Lead — Relocating from Chicago • Follow-up due today</div>
            </div>
            <div class="contact-actions">
              <button class="btn-action primary" onclick="logAction(this,'Called Liu')">📞 Call</button>
          ...
          <div class="contact-row">
            ...
            <div class="contact-info">
              <div class="contact-name">Thomas Cruz <span class="heat-badge heat-warm">WARM</span></div>
              <div class="contact-meta">FSBO — 3812 Stoneybrook • Owner not listed with agent yet</div>
            </div>
            <div class="contact-actions">
              <button class="btn-action primary" onclick="logAction(this,'Called Cruz')">📞 Call</button>
          ...
          <div class="contact-row">
            ...
            <div class="contact-info">
              <div class="contact-name">Beth & Paul Nguyen <span class="heat-badge heat-cold">COLD</span></div>
              <div class="contact-meta">Sphere — Past clients 2022 • Anniversary check-in (3 yr)</div>
            </div>
            <div class="contact-actions">
              <button class="btn-action" onclick="logAction(this,'Texted Nguyen')">✉ Text</button>
