...
<body>
  ...
  <style>
    .concierge-launcher {{
      ...
      border-radius: var(--pill-radius);
      cursor: pointer;
      box-shadow: 0 12px 36px rgba(0, 0, 0, 0.65), 0 0 18px rgba(229, 200, 144, 0.15);
      transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1);
    }}
    .concierge-launcher:hover {{
      transform: translateY(-3px) scale(1.02);
      border-color: var(--gold-accent);
      box-shadow: 0 16px 40px rgba(0, 0, 0, 0.8), 0 0 24px rgba(229, 200, 144, 0.3);
    }}
    ...
    .concierge-window {{
      ...
      border-radius: 24px;
      box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.9), 0 0 30px rgba(229, 200, 144, 0.1);
      z-index: 860;
      display: flex;
      flex-direction: column;
      overflow: hidden;
